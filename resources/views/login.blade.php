            ...
            <form  action="{{route('logar')}}" method="post">
                ...
                <div class="input-group mb-1">
                    <div class="form-floating">
                        <input name="email" id="loginEmail" type="email" class="form-control" value="{{isset($email)?$email:old('email',isset($usuario)?$usuario->email:'')}}" placeholder="" />
                ...
                <div class="row">
                    <div class="col-8 d-inline-flex align-items-center">
                        <div class="form-check">
                            <input class="form-check-input" name="lembrar" type="checkbox" value="" id="flexCheckDefault" />
