...
<div class="row">
    <div class="col-md-12">
        <div class="card mb-5">
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <form  action="{{route('montadora.index')}}">
                    <div class="row g-3">
                        <div class="col-md-3">
        ...
        <div class="card mb-5">
            <div class="card-header"><h3 class="card-title"><i class="bi bi-database"></i> {{$titulo_tabela}} </h3>
                <div class="card-tools">
                    @can('montadora-criar')
                    <a class="btn btn-sm btn-primary" href="{{route('montadora.novo')}}"><i class="fa fa-plus" aria-hidden="true"></i> Novo</a>
                    @endcan
                </div></div>
            <!-- /.card-header -->
            <div class="card-body">
                    ...
                    @foreach($montadoras as $montadora)
                        <tr class="align-middle">
                            ...
                            <td>
                                ...
                                @endcan
                                @can('montadora-editar')
                                <a href="{{route('montadora.editar',['montadora'=>$montadora])}}" class="text-decoration-none">
