...
<div class="row">
    <div class="col-md-12">
        <div class="card mb-5">
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <form  action="{{route('tipoPagamento.index')}}">
                    <div class="row g-3">
                        <div class="col-md-3">
        ...
        <div class="card mb-5">
            <div class="card-header"><h3 class="card-title"><i class="bi bi-database"></i> {{$titulo_tabela}} </h3>
                <div class="card-tools">
                    @can('grupo-criar')
                    <a class="btn btn-sm btn-primary" href="{{route('tipoPagamento.novo')}}"><i class="fa fa-plus" aria-hidden="true"></i> Novo</a>
                    @endcan
                </div></div>
            <!-- /.card-header -->
            <div class="card-body">
                <table class="table table-bordered" role="table">
                    ...
                    @foreach($tipos  as $tipo)
                        <tr class="align-middle">
                            ...
                            <td><span class="badge  {{$tipo->ativo==1?"bg-success":"bg-danger"}}">{{$tipo->ativo==1?"Sim":"Não"}}</span></td>
                            <td>
                                ...
                                @endcan
                                @can('grupo-editar')
                                <a href="{{route('tipoPagamento.editar',['tipo'=>$tipo])}}" class="text-decoration-none">
